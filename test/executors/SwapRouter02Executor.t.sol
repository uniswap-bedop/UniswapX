...
contract SwapRouter02ExecutorTest is Test, PermitSignature, DeployPermit2 {
    ...
    function testReactorCallback() public {
        ...
        ExactInputParams memory exactInputParams = ExactInputParams({
          ...
          bytes memory payload = "";
   
        multicallData[0] = abi.encodeWithSelector(ISwapRouter02.exactInput.selector, exactInputParams);
        bytes memory callbackData = abi.encode(tokensToApproveForSwapRouter02, tokensToApproveForReactor, multicallData,payload);
    ...
    function testExecute() public {
        ...
        swapRouter02Executor.execute(
            ...
            abi.encode(tokensToApproveForSwapRouter02, tokensToApproveForReactor, multicallData, payload)
        );
        vm.stopSnapshotGas();
