...
export interface BebopExecutorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "execute"
      | "executeBatch"
...
export interface BebopExecutor extends BaseContract {
  connect(runner?: ContractRunner | null): BebopExecutor;
  waitForDeployment(): Promise<this>;

  interface: BebopExecutorInterface;
